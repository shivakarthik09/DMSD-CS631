...
<body>
  ...
  <div class="container">
      ...
      <div class="row">
          ...
          <div class="col-md-9">
    <div class="content">
        <h2>Edit Copies & Status</h2>
        <!-- Vertical form for inserting and deleting a document copy -->
        <form action="admin_functions.php?function=EditDocumentCopy" method="post">
        ...
        <!-- Form for deleting a document copy -->
        <form action="admin_functions.php?function=DeleteDocumentCopy" method="post">
            <div class="form-group">
                <label for="deleteCopyId">Copy ID to delete:</label>
                <input type="text" class="form-control" id="CopyId" name="CopyId">
            </div>
